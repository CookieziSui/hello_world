...
<div id="customize_date" class="modal message hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="control-group">
                <div class="controls">
                    <div data-date-format="yyyy-mm-dd" data-date="<?php echo $today; ?>" class="input-append date">
                        <input type="text" id="cus_date_from" class="span2" name="cus_date_from" placeholder="Date From" required>
                        <span class="add-on"><i class="icon-calendar"></i></span>
                    </div>
                    <span class="form-title">--</span>
                    <div data-date-format="yyyy-mm-dd" data-date="<?php echo $today; ?>" class="input-append date">
                        <input type="text" id="cus_date_to" class="span2" name="cus_date_to" placeholder="Date To" required>
                        <span class="add-on"><i class="icon-calendar"></i></span>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-info" id="cus_date_confirm">Confirm</button>
            </div>
        </form>
    </div>
</div>
<!--Dialog: Customize date scope box  -->
<div id="invald_date" class="modal message hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-body">
        <span class="form-title">Wrong date scope, please a choose a valid date scope!</span>
        <div class="modal-footer">
            <button type="button" class="btn btn-info" id="btn_invald_date">Close</button>
        </div>
    </div>
</div>
<script>
    $(function() {
        $('.date').datepicker();
        $("#btn_invald_date").live("click",function(){
            $("#invald_date").modal("hide");
        });
    });
...
<div id="task_status_date">
    ...
    <select id="date_scope_view" class="span2">
